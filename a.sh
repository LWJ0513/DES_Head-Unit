...
# docker cp qt-headunit-container:/project/build/HeadUnit .

DOCKER_IMAGE_NAME="qt-headunit-builder"
DOCKER_CONTAINER_NAME="qt-headunit-container"
BUILD_DIR="/usr/project/build"
HOST_COPY_DIR="/Users/LWJ/subject/sea-me/DES_Head-Unit"
RASPBERRY_PI_USER="falcon"
# RASPBERRY_PI_HOST="192.168.1.129"
...
# sshpass -p "$RASPBERRY_PI_USER" rm $RASPBERRY_PI_TARGET_DIR/InstrumentCluster
# sshpass -p "$RASPBERRY_PI_USER" ssh $RASPBERRY_PI_USER@$RASPBERRY_PI_HOST "rm $RASPBERRY_PI_TARGET_DIR/InstrumentCluster"
